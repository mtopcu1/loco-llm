...
| Layer | Role |
|-------|------|
| `src/llm_cli/commands/` | Typer commands; setup chain (`setup_chain.py`); runtime wizards (`runtime_setup.py`) |
| `src/llm_cli/core/` | Settings, paths, lifecycle, registry, `serve_modes` + `serve`, events |
